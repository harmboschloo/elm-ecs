...
module EcsGenerator.Example.Ecs exposing
    ...
    , BoundsNode, MovementNode, RenderNode
    , boundsNode, movementNode, renderNode
    )
...
@docs BoundsNode, MovementNode, RenderNode
...
type alias Model =
    { colorComponents : Array.Array (Maybe EcsGenerator.Example.Components.Color)
    , positionComponents : Array.Array (Maybe EcsGenerator.Example.Components.Position)
    , velocityComponents : Array.Array (Maybe EcsGenerator.Example.Components.Velocity)
    , boundsEntities : Set.Set Int
...
resetEntity entityId model =
    { model
        ...
        , boundsEntities = Set.remove entityId model.boundsEntities
...
entitiesSize model =
    Array.length model.colorComponents
...
positionComponent =
    ComponentType
        ...
        , entitySets = [ boundsEntitySet, movementEntitySet, renderEntitySet ]
        }
...
{-| -}
type alias BoundsNode =
    { position : EcsGenerator.Example.Components.Position
    }
...
type alias MovementNode =
    { position : EcsGenerator.Example.Components.Position
    , velocity : EcsGenerator.Example.Components.Velocity
    }


{-| -}
type alias RenderNode =
    { color : EcsGenerator.Example.Components.Color
    , position : EcsGenerator.Example.Components.Position
    }
...
{-| -}
boundsNode : NodeType BoundsNode
boundsNode =
    NodeType
        { getEntities = .boundsEntities
        , getNode =
            \entityId model ->
                BoundsNode
...
boundsEntitySet : EntitySetType
boundsEntitySet =
    { getEntities = .boundsEntities
    , setEntities = \entities model -> { model | boundsEntities = entities }
    , member =
        \entityId model ->
