...
@docs ComponentA, ComponentB, ComponentC
...
type alias ComponentSpecs =
    { a : ComponentSpec ComponentA
    , b : ComponentSpec ComponentB
    , c : ComponentSpec ComponentC
    }
...
{-| -}
type alias Ecs =
    Ecs.Spec.Ecs3 EntityId ComponentA ComponentB ComponentC


spec : Ecs.Spec.Spec ComponentSpecs EntityId Ecs
spec =
    Ecs.Spec.spec3 ComponentSpecs
