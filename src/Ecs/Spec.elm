...
{-| Create all specifications for 5 component types.
-}
specs5 :
    (Spec (Components5 a1 a2 a3 a4 a5)
...
{-| Create all specifications for 6 component types.
-}
specs6 :
    (Spec (Components6 a1 a2 a3 a4 a5 a6)
...
{-| Create all specifications for 7 component types.
-}
specs7 :
    (Spec (Components7 a1 a2 a3 a4 a5 a6 a7)
...
{-| Create all specifications for 8 component types.
-}
specs8 :
    (Spec (Components8 a1 a2 a3 a4 a5 a6 a7 a8)
...
{-| Create all specifications for 9 component types.
-}
specs9 :
    (Spec (Components9 a1 a2 a3 a4 a5 a6 a7 a8 a9)
...
{-| Create all specifications for 10 component types.
-}
specs10 :
    (Spec (Components10 a1 a2 a3 a4 a5 a6 a7 a8 a9 a10)
...
{-| Create all specifications for 11 component types.
-}
specs11 :
    (Spec (Components11 a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11)
...
{-| Create all specifications for 12 component types.
-}
specs12 :
    (Spec (Components12 a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11 a12)
