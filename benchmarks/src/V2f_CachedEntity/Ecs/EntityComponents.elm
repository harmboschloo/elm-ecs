module V2f_CachedEntity.Ecs.EntityComponents exposing
    ( foldl, foldr
    , foldl2, foldr2
    , foldl3, foldr3
    , foldl4, foldr4
...
import V2f_CachedEntity.Ecs exposing (World)
...
foldWorldl :
    ComponentSpec comparable a components
    -> (comparable -> a -> World comparable components singletons -> World comparable components singletons)
    -> World comparable components singletons
    -> World comparable components singletons
foldWorldl (ComponentSpec spec) fn (World world) =
    Dict.foldl
        (\id a (World w) ->
            fn id
                a
