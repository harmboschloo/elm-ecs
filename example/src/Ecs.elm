        ...
        [] ->
            ( Ecs_
                { model_
                    ...
                    , transformsComponents = Array.push Nothing model_.transformsComponents
...
removeEntityComponents_ entityId_ model_ =
    { model_
        ...
        , transformsComponents = Array.set entityId_ Nothing model_.transformsComponents
        ...
        , transformEntities = Set.remove entityId_ model_.transformEntities
    }
...
transformsComponent =
    ComponentType
        ...
        , setComponents = \components_ model_ -> { model_ | transformsComponents = components_ }
        , entitySets = [ transformEntitySet_ ]
        }
...
transformNode =
    NodeType
        ...
        , getNode =
            \entityId_ model_ ->
                TransformNode
                    |> nextComponent_ model_.transformsComponents entityId_
        }
...
transformEntitySet_ : EntitySetType_
transformEntitySet_ =
    { getEntities = .transformEntities
    , setEntities = \entities_ model_ -> { model_ | transformEntities = entities_ }
    , member =
        \entityId_ model_ ->
            isComponentsMember_ entityId_ model_.transformsComponents
    }
